...
const Information_modal = () => {
    ...
    const [weather, temp, wind, humidity, visibility] = [day.weather[0].main, day.main.temp, day.wind.speed, day.main.humidity, day.visibility / 1000]
    ...
    return (
        <div className='info-modal'>
            <div className='header-modal'>
                <button onClick={handleModal}><IoCloseOutline size={25}/></button>
                <p>{nameCountry}</p>
            </div>
            <div className="main">
